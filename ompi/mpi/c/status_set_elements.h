...
#if !defined(OMPI_C_STATUS_SET_ELEMENTS_H)
#define OMPI_C_STATUS_SET_ELEMENTS_H
...
static inline int _MPI_Status_set_elements(const char *func_name, MPI_Status *status, MPI_Datatype datatype,
                                           MPI_Count count)
{
    int rc = MPI_SUCCESS;
    size_t size;
